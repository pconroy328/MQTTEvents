/*
    To Use this in other Maven Projects, go to THAT Project's pom.xml
        Do "Insert Code"
        Pick "Dependency"
        Then "Open Projects" and select THIS project
    You'll end up with:
        <!-- Attempt to include my Local JAR as a dependency-->
        <!-- Used Netbeans Built-in add Dependency Code insertion -->
        <dependency>
            <groupId>${project.groupId}</groupId>
            <artifactId>MQTTEvents</artifactId>
